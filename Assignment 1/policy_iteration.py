...
class Agent():
    ...
    def evaluate_policy(self):
        theta = .001  # Convergence threshold
...
if __name__ == '__main__':
    ...
    column_headers = [f"({x}, {y})" for y in range(6) for x in range(6)]
    ...
    csv_filename = "policy_iteration_each_step.csv"
    csv_filepath = os.path.join(script_dir, csv_filename)

    csv_filename2 = "policy_iteration_final_utilities.csv"
